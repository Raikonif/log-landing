          ...
          <div>
            <div className="pl-12">
              <p className="peer mb-6 text-gray-600">
                ¿Necesitas importar productos de manera segura y eficiente? Nuestro servicio
                marítimo te ofrece una opción confiable y económica para traer tus mercancías desde
                cualquier parte del mundo. Contamos con una amplia red de agentes y socios
                logísticos que garantizan un transporte seguro y una entrega puntual.
              </p>
