          ...
          <div>
            <div className="pl-12">
              <p className="peer mb-6 text-gray-600">
                ¡Importa con confianza! Introducimos nuestro nuevo servicio de verificación de
                proveedores para importación. Si estás buscando expandir tu negocio a través de la
                importación, sabemos lo importante que es contar con socios comerciales confiables y
                de calidad. Nuestro servicio de verificación de proveedores te brinda la
                tranquilidad que necesitas al seleccionar a tus proveedores en el extranjero.
                Nuestro equipo especializado se encargará de evaluar cuidadosamente a cada proveedor
                potencial, asegurándose de que cumplan con los más altos estándares de calidad y
                confiabilidad.
              </p>
