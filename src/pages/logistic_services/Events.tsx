          ...
          <div>
            <div className="pl-12">
              <p className="peer mb-6 text-gray-600">
                ¡Descubre nuevos horizontes con nuestros proyectos y eventos de importación!
                Conéctate con expertos de la industria, descubre nuevas oportunidades comerciales y
                amplía tus conocimientos sobre importación. Únete a nosotros y sé parte de un mundo
                de posibilidades. ¡No te pierdas nuestros próximos proyectos y eventos de
                importación!
              </p>
