      ...
      <div className="mx-auto grid max-w-screen-xl px-4 pb-8 pt-20 lg:grid-cols-12 lg:gap-8 lg:py-16 lg:pt-28 xl:gap-0">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <p className="mb-6 max-w-2xl font-light text-gray-500 md:text-lg lg:mb-8 lg:text-xl dark:text-gray-400">
            En [Nombre de la Compañía], nos especializamos en el desarrollo de software para logística, 
            ofreciendo soluciones personalizadas y eficientes. Con un equipo comprometido y una atención centrada en el cliente, 
            trabajamos para impulsar el éxito operativo de nuestros clientes en la industria de la logística.
          </p>
        </div>
